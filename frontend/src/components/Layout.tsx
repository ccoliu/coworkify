...
import { LayoutWidthProvider, useLayoutWidth } from '../context/LayoutContext'
...
export function LayoutShell() {
  ...
  const { wide } = useLayoutWidth()

  return (
    <div className="min-h-screen bg-plane">
      <div className={clsx('flex min-h-screen', wide ? 'w-full' : 'mx-auto max-w-[96rem]')}>
